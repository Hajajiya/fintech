...
import { View, Text, TextInput, StyleSheet, ImageBackground, Dimensions, TouchableOpacity, KeyboardAvoidingView, ScrollView, Alert } from "react-native";
                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
                        ...
                        <View style={styles.container}>
                            <View style={styles.headerView}>
                                <Text style={styles.header}>{'Welcome To Log in'}</Text>
                            </View>
                            <TextInput
                                style={styles.input}
